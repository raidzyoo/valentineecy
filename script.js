...
function navigateTo(pageNumber) {
    ...
    setTimeout(() => {
        ...
        if (pageNumber === 3) {
    if (!state.musicPlaying && elements.bgMusic) {
...
function initEventListeners() {
    ...
    elements.restartBtn.addEventListener('click', cinematicRestart);
...
function fadeVolume(targetVolume, duration = 1500) {
